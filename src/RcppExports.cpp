...
RcppExport SEXP _spruce_hshrink_regr(SEXP left_childrenSEXP, SEXP right_childrenSEXP, SEXP num_samples_nodesSEXP, SEXP node_predictionsSEXP, SEXP split_valuesSEXP, SEXP lambdaSEXP, SEXP nodeIDSEXP, SEXP parent_nSEXP, SEXP parent_predSEXP, SEXP cum_sumSEXP)
{
    BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _spruce_hshrink_prob(SEXP left_childrenSEXP, SEXP right_childrenSEXP, SEXP num_samples_nodesSEXP, SEXP class_freqSEXP, SEXP lambdaSEXP, SEXP nodeIDSEXP, SEXP parent_nSEXP, SEXP parent_predSEXP, SEXP cum_sumSEXP)
{
    BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter<Rcpp::IntegerVector &>::type left_children(left_childrenSEXP);
...
RcppExport SEXP _spruce_replace_class_counts(SEXP class_counts_oldSEXP, SEXP class_counts_newSEXP)
{
    BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_spruce_hshrink_regr", (DL_FUNC)&_spruce_hshrink_regr, 10},
    {"_spruce_hshrink_prob", (DL_FUNC)&_spruce_hshrink_prob, 9},
    {"_spruce_replace_class_counts", (DL_FUNC)&_spruce_replace_class_counts, 2},
    {NULL, NULL, 0}};
